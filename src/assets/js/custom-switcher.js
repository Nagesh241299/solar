...
$(document).on("click", '#myonoffswitch24', function () {
    if (this.checked) {
        ...
        (document.getElementById("style").setAttribute("href", "./assetsplugins/bootstrap/css/bootstrap.rtl.min.css"));
...
$(document).on("click", '#myonoffswitch23', function () {
    if (this.checked) {
        ...
        $("head link#style").attr("href", $(this));
        (document.getElementById("style").setAttribute("href", "./assetsplugins/bootstrap/css/bootstrap.min.css"));
        var carousel = $('.owl-carousel');
        $.each(carousel, function (index, element) {
            // element == this
            var carouselData = $(element).data('owl.carousel');
