...
export class SwitcherComponent implements OnInit {
  ...
  reset(){
    ...
    html?.classList.remove('Volgh-primary-rgb');
    html?.classList.remove('Volgh-primary-rgb1');
    //remove
  ...
  DarkTheme(){
   ...
   hexToRgb(hexColor: string) {
    hexColor = hexColor.replace(/^#/, ''); // Remove the '#' symbol if present
 ...
 hexColorCode = "#FFA500"; // Replace this with the hex color code you want to convert
 rgbValues = this.hexToRgb(this.hexColorCode);

  public dynamicBgPrimary(data: string): void {
    this.color3 = data;
    switcher.dynamicBgPrimaryColor(this.color3);
    localStorage.setItem('Volgh-primary-rgb', `${this.hexToRgb(data)[0]},${this.hexToRgb(data)[1]},${this.hexToRgb(data)[2]}`);
    localStorage.setItem('Volgh-primary-rgb1', this.color3);
    ...
    localStorage.removeItem('Volghlight-primary-color');
    localStorage.removeItem('Volghlight-primary-hover');
    localStorage.removeItem('Volghlight-primary-border');
    localStorage.removeItem('Volghdark-primary-color');
    localStorage.removeItem('Volghdark-primary-hover');
    localStorage.removeItem('Volghdark-primary-border');
    localStorage.removeItem('Volghdark-body');
  ...
  public dynamicBgDarkPrimary(data: string): void {
    ...
    localStorage.removeItem('Volghlight-primary-border');
    localStorage.removeItem('Volghdark-primary-color');
    localStorage.removeItem('VolghBgImage');
    switcher.removeForTransparent();
    switcher.updateChanges();
  }
